...
CREATE TABLE public.order_status (
                id BIGINT NOT NULL DEFAULT nextval('public.order_status_id_seq'),
...
CREATE TABLE public.stock (
                id BIGINT NOT NULL DEFAULT nextval('public.stock_id_seq'),
...
CREATE TABLE public.region (
                id BIGINT NOT NULL DEFAULT nextval('public.region_id_seq'),
                name VARCHAR NOT NULL,
...
CREATE TABLE public.department (
                id BIGINT NOT NULL DEFAULT nextval('public.department_id_seq'),
                name VARCHAR NOT NULL,
...
CREATE TABLE public.city (
                id BIGINT NOT NULL DEFAULT nextval('public.city_id_seq'),
                name VARCHAR NOT NULL,
...
CREATE TABLE public.store (
                id BIGINT NOT NULL DEFAULT nextval('public.store_id_seq'),
                name VARCHAR NOT NULL,
...
CREATE TABLE public.customer_type (
                id BIGINT NOT NULL DEFAULT nextval('public.customer_type_id_seq'),
...
CREATE TABLE public.command (
                id BIGINT NOT NULL DEFAULT nextval('public.command_id_seq'),
